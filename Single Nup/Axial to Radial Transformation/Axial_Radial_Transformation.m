...
function [] = Axial_Radial_Transformation()
    ...
    working_dir = 'G:\New\YangLab\Projects\Single Nup\SingleNup\Tranformation\';
    filename = [working_dir filesep file];
    % here specify the level of smoothing
    smooth_window = 2;
    % 
    d = 360;
    ranges = { [-120 -20], [-20 20], [20 120] };
    for j = 1:length(ranges)
        Chi = [];
       for i = 5 %dr loop, here indicate bin size you want to use.
